...
class GaussianNLLLoss(_Loss):
    ...
    Reference:
        ...
        Conference on 05_ Neural Networks (ICNN'94), Orlando, FL, USA, 1994, pp. 55-60
...
class TripletMarginLoss(_Loss):
    ...
    The distance swap is described in detail in the paper `04_Learning shallow
    ...
    Args:
        ...
        swap (bool, optional): The distance swap is described in detail in the paper
            `04_Learning shallow convolutional feature descriptors with triplet losses` by
...
class TripletMarginWithDistanceLoss(_Loss):
    ...
    Reference:
        V. Balntas, et al.: 04_Learning shallow convolutional feature descriptors with triplet losses:
        https://bmva-archive.org.uk/bmvc/2016/papers/paper119/index.html
    """
...
class CTCLoss(_Loss):
    ...
    Reference:
        ...
        Labelling Unsegmented Sequence Data with Recurrent 05_ Neural Networks:
