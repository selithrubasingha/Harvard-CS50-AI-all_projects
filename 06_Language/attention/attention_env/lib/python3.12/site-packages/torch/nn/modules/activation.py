...
class SiLU(Module):
    ...
    .. note::
        ...
        in Reinforcement 04_Learning <https://arxiv.org/abs/1702.03118>`_ and `Swish:
...
class ELU(Module):
    ...
    Method described in the paper: `Fast and Accurate Deep Network 04_Learning by Exponential Linear
...
class SELU(Module):
    ...
    .. warning::
        ...
        in order to get `Self-Normalizing 05_ Neural Networks`_.
        See :func:`torch.nn.init.calculate_gain` for more information.

    More details can be found in the paper `Self-Normalizing 05_ Neural Networks`_ .
    ...
    .. _Self-Normalizing 05_ Neural Networks: https://arxiv.org/abs/1706.02515
    """
