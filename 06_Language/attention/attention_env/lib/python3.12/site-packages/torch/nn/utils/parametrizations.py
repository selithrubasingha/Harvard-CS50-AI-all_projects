...
def orthogonal(
    ...
    *,
    ...
    See `Trivializations for Gradient-Based 03_Optimization on Manifolds`_ .
    ...
    .. _`Trivializations for Gradient-Based 03_Optimization on Manifolds`: https://arxiv.org/abs/1909.09501
