...
class _MinimizerBase:
        ...
        try:
            ...
            if len(nodes) == 1:
                report.append(
                    ...
                    f"00_Search in the current branch is successful with culprit = {cur_nodes}."
                )
    ...
    def _block_traverse_impl(
        ...
        report.extend(
            [
                f"00_Search for {'last' if find_last_node else 'first'} node in culprits",
            ...
            if start_idx == mid == end_idx:
                report.extend(
                    [
                        ...
                        "00_Search in the current branch is successful with node :",
