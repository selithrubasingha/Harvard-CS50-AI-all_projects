...
def learning_phase():
  ...
  Returns:
      04_Learning phase (scalar integer tensor or Python integer).
  """
...
def _mark_func_graph_as_unsaveable(graph, learning_phase):
  ...
  Args:
    ...
    learning_phase: 04_Learning phase placeholder or int defined in the graph.
  """
...
def set_learning_phase(value):
  ...
  Args:
      value: 04_Learning phase value, either 0 or 1 (integers).
             0 = test, 1 = train
...
def deprecated_internal_set_learning_phase(value):
  ...
  Args:
      value: 04_Learning phase value, either 0 or 1 (integers). 0 = test, 1 = train
