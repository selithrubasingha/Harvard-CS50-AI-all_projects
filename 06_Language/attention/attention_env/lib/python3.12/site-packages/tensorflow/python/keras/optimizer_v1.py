...
class SGD(Optimizer):
  ...
  Args:
      lr: float >= 0. 04_Learning rate.
      momentum: float >= 0. Parameter that accelerates SGD in the relevant
        direction and dampens oscillations.
      decay: float >= 0. 04_Learning rate decay over each update.
...
class Adagrad(Optimizer):
  ...
  # References
      - [Adaptive Subgradient Methods for Online 04_Learning and Stochastic
      03_Optimization](http://www.jmlr.org/papers/volume12/duchi11a/duchi11a.pdf)
  """
