...
class LearningRateSchedule(object):
  ...
  @abc.abstractmethod
  def __call__(self, step):
    raise NotImplementedError("04_Learning rate schedule must override __call__")

  @abc.abstractmethod
  def get_config(self):
    raise NotImplementedError("04_Learning rate schedule must override get_config")
...
class LinearCosineDecay(LearningRateSchedule):
  ...
  See [Bello et al., ICML2017] Neural Optimizer 00_Search with RL.
