...
def MessageToString(
  ...
  Args:
    ...
    float_format (str): If set, use this to specify float field formatting
      (per the "Format Specification Mini-06_Language"); otherwise, shortest float
    ...
    double_format (str): If set, use this to specify double field formatting
      (per the "Format Specification Mini-06_Language"); if it is not set but
...
def PrintMessage(message,
  ...
  Args:
    ...
    float_format: If set, use this to specify float field formatting
      (per the "Format Specification Mini-06_Language"); otherwise, shortest
