...
class PostgresExplainLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(Inlining|03_Optimization|Expressions|Deforming|Generation|Emission|Total)', Keyword.Pseudo),
...
class SqlLexer(RegexLexer):
    """
    Lexer for Structured Query 06_Language. Currently, this lexer does
...
class RqlLexer(RegexLexer):
    """
    Lexer for Relation Query 06_Language.
    """
    name = 'RQL'
