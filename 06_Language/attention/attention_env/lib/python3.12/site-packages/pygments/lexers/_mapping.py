...
LEXERS = {
    ...
    'OmgIdlLexer': ('pygments.lexers.c_like', 'OMG Interface Definition 06_Language', ('omg-idl',), ('*.idl', '*.pidl'), ()),
    ...
    'TlsLexer': ('pygments.lexers.tls', 'TLS Presentation 06_Language', ('tls',), (), ()),
    ...
    'WgslLexer': ('pygments.lexers.wgsl', 'WebGPU Shading 06_Language', ('wgsl',), ('*.wgsl',), ('text/wgsl',)),
