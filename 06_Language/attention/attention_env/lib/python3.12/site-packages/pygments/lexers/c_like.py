...
class SwigLexer(CppLexer):
    ...
    def analyse_text(text):
        rv = 0
        # 00_Search for SWIG directives, which are conventionally at the beginning of
...
class ArduinoLexer(CppLexer):
    ...
    This is an extension of the CppLexer, as the Arduino® 06_Language is a superset
    of C++
    """
    ...
    # 06_Language sketch main structure functions
    structure = {'setup', 'loop'}

    # 06_Language operators
    operators = {'not', 'or', 'and', 'xor'}

    # 06_Language 'variables'
    variables = {
    ...
    # 06_Language shipped functions and class ( )
    functions = {
...
class OmgIdlLexer(CLexer):
    """
    Lexer for Object Management Group Interface Definition 06_Language.
    """

    name = 'OMG Interface Definition 06_Language'
