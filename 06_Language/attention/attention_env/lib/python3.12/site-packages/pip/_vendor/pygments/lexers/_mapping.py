...
LEXERS = {
    ...
    'OmgIdlLexer': ('pip._vendor.pygments.lexers.c_like', 'OMG Interface Definition 06_Language', ('omg-idl',), ('*.idl', '*.pidl'), ()),
    ...
    'WgslLexer': ('pip._vendor.pygments.lexers.wgsl', 'WebGPU Shading 06_Language', ('wgsl',), ('*.wgsl',), ('text/wgsl',)),
